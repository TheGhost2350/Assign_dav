...
# Convert the 'Column2' values to a numpy array to fix the TypeError issue
column2_values = df['Column2'].to_numpy()

# Use the pandas cut function to discretize the second column into 5 bins
df['Column2_bins'] = pd.cut(column2_values, bins=num_bins)

# Display the DataFrame with the discretized column
print("DataFrame with Discretized Second Column into 5 Bins: \n", df)
print()